            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xs-12">
                    <div class="shop-cover">
                        <img src="{{asset('images/shop_cover.jpg')}}" alt="" width="100%">
                        <div class="shop-profile">
                            <img src="{{asset('images/default.png')}}" alt="" width="100">
                        </div>
                        <div class="shop-name">Nika Online Shop</div>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_1.png')}}" alt=""></div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_2.png')}}" alt=""></div>
                                <div class="product-content">
                        ...
                        <!-- /.product -->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_3.png')}}" alt=""></div>
                                <div class="product-content">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_5.png')}}" alt=""></div>
                                <div class="product-content">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_6.png')}}" alt=""></div>
                                <div class="product-content">
                                    <h5><a href="#" class="product-title">HTC U Ultra <strong>(64GB, Blue)</strong></a></h5>
                                    <div class="product-meta"><a href="#" class="product-price">$1200</a>
                                        <a href="#" class="discounted-price">$1700</a>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_7.png')}}" alt=""></div>
                                <div class="product-content">
                                    <h5><a href="#" class="product-title">HTC U Ultra <strong>(64GB, Blue)</strong></a></h5>
                                    <div class="product-meta"><a href="#" class="product-price">$1200</a>
                                        <a href="#" class="discounted-price">$1700</a>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                            <div class="product-block">
                                <div class="product-img"><img src="{{asset('images/product_img_8.png')}}" alt=""></div>
                                <div class="product-content">
                                    <h5><a href="#" class="product-title">HTC U Ultra <strong>(64GB, Blue)</strong></a></h5>
                                    <div class="product-meta"><a href="#" class="product-price">$1200</a>
                                        <a href="#" class="discounted-price">$1700</a>
